  ...
  myApp.controller(
    ...
    function (
      ...
      $scope.toggleLangModel = {
        lang:
          window.localStorage.getItem("lang") == "zh_cn" ? "中文" : "English",
        click: function (la) {
      ...
      $scope.globalData = {
        ...
        refreshText: function () {
          ...
          $scope.globalData.cityDress =
            $scope.globalData.city + ", " + $scope.globalData.country;
      ...
      $scope.forecastChartMultiModel = {
        ...
        onChange: function (value) {
          if (value == "Wind") {
            ...
            $scope.forecastChartMultiModel.datasetOverride[0].label =
              T.T("windPieChart");
            $scope.forecastChartMultiModel.datasetOverride[1].label =
              T.T("windSpeedCurve");
      ...
      function achieveAllWeatherData(v_c) {
        ...
        $http({
          ...
          function (response) {
            ...
            angular.forEach(
              rForecastWeather.dateList.slice(0, 12),
              function (item, index) {
                var tm = $filter("date")(
                ...
                g_pageData.v_HourlyTableDatasF.push({
                  ...
                  temp: toFahrenheit(item.temperature) + " °F",
                  color:
                    toFahrenheit(item.temperature) < 70
                      ? "font-def-type-1"
                      : "font-def-type-2",
                  summary:
                    item.windSpeed +
            ...
            angular.forEach(
              rForecastWeather.dateList.slice(12),
              function (item, index) {
                var tm = $filter("date")(
                  parseInt(item.date) * 1000,
                  "MM-dd HH:mm"
